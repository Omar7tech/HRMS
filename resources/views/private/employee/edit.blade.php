...
<section class="home-section" style="margin-bottom: 500px">
    ...
    <div class="mycontent">
        ...
        <div class="container-sm mt-5">
            <form class="row g-3 needs-validation" action="{{ route('employee.update', $data->id) }}" method="POST"
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('position') is-invalid @enderror" id="position" name="position">
                        <option value="{{ $data->position->id }}">{{ $data->position->name ?: 'Select position' }}
                        </option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('emergency_contact') is-invalid @enderror"
                        id="emergency_contact" name="emergency_contact" value="{{ $data->emergency_contact }}">
                ...
                <div class="col-md-6">
                    ...
                    @if ($data->cv)
                        <div>
                            <a href="{{ asset('storage/' . $data->image) }}" target="_blank">View Current image</a>
                        </div>
                    @endif
